      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {heroImages.map((item) => (
          ...
          >
            ...
            {/* Label (left aligned) */}
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm text-gray-900 text-sm font-medium px-4 py-2 rounded-md shadow-lg transform group-hover:scale-105 transition-transform duration-300">
              {item.label}
            </div>
          </div>
        ))}
