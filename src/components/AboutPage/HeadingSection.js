  ...
  return (
    <div className="text-center max-w-5xl mx-auto py-20 relative">
      ...
      <div className="inline-block absolute left-40 top-12 lg:left-110 lg:top-10">
        <span className="py-2.5 md:py-2 lg:py-2.5 px-6 md:px-6 lg:px-8 bg-transparent border border-black rounded-full rounded-bl-none text-black hover:bg-black hover:text-white text-sm lg:text-2xl tracking-wide">
          Hey! I&apos;m
        </span>
      </div>
      ...
      <h1 
        className="text-5xl sm:text-6xl text-[54px] lg:text-[112px] font-bold mb-8 leading-tight"
        style={{
      ...
      {/* Description */}
      <p className="text-base md:text-md text-gray-600 leading-relaxed max-w-[380px] md:max-w-[780px] mx-auto">
