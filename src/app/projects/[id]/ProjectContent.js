            ...
            <div className="relative group">
              ...
              <div className="hidden md:block">
                <button
                  ...
                  className={`absolute left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-white shadow-lg border border-gray-200 flex items-center justify-center transition-all duration-300 ${
                    currentState.isAtStart 
                      ? 'opacity-50 cursor-not-allowed' 
                      : 'hover:bg-gray-50 hover:shadow-xl opacity-0 group-hover:opacity-100'
                  }`}
                >
                ...
                <button
                  ...
                  className={`absolute right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-white shadow-lg border border-gray-200 flex items-center justify-center transition-all duration-300 ${
                    currentState.isAtEnd 
                      ? 'opacity-50 cursor-not-allowed' 
                      : 'hover:bg-gray-50 hover:shadow-xl opacity-0 group-hover:opacity-100'
                  }`}
                >
